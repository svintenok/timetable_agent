...
INSERT INTO restriction(name, factor_id, operation_id, restriction_value, hard, priority) VALUES ('Максимальное число пар подряд не должно превышать четырех', 6, 3, 4, FALSE, 3);--4
INSERT INTO restriction(name, factor_id, operation_id, restriction_value, hard, priority) VALUES ('Не должно быть единственной пары в день', 4, 1, 1, FALSE, 2);--5
INSERT INTO restriction(name, factor_id, operation_id, restriction_value, hard, priority) VALUES ('Максимальное число окон подряд не должно превышать двух', 5, 3, 2, FALSE, 4);--6
