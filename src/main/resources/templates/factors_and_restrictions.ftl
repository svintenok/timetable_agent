        ...
        <div class="col-md-7 themed-grid-col">
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                ...
                <div class="mb-2 mb-md-0">
                    <a href="/restrictions/add" class="btn btn-outline-dark"><i class="fa fa-plus"></i> Добавить ограничение</a>
                </div>
            </div>
            <br>
            ...
            <#list restrictions as restriction>
                <a href="/restrictions/${restriction.id}" class="list-group-item list-group-item-action">
